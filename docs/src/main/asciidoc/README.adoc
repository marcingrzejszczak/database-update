...
Before we go into details we need to define a couple of assumptions towards our applications. The key result that we
 ...
 TIP: Business PRO-TIP. Simplifying processes can save you a lot of money on support (the more people work in your company the
...
All the code used in this article is available at https://github.com/marcingrzejszczak/database-update[Github]. Below you can find
