...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v3/src/main/resources/db/migration/V3__Final_migration.sql[]
----
...
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v3/src/main/java/sample/flyway/Person.java[]
----