...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v4/src/main/resources/db/migration/V4__Remove_lastname.sql[]
----
