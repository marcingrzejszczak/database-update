...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v2-newcolumn/src/main/resources/db/migration/V2__Add_age.sql[]
----
...
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v2-newcolumn/src/main/java/sample/flyway/Person.java[]
----
