...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v2/src/main/resources/db/migration/V1__init.sql[]
----
...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v2/src/main/resources/db/migration/V2__Add_surname.sql[]
----
...
----
include::https://raw.githubusercontent.com/marcingrzejszczak/database-update/master/boot-flyway-v2/src/main/java/sample/flyway/Person.java[]
----