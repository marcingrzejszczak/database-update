...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/{organization}/{repo}/master/{module}/src/main/resources/db/migration/V1__init.sql[]
----
...
[source,sql,indent=0]
----
include::https://raw.githubusercontent.com/{organization}/{repo}/master/{module}/src/main/resources/db/migration/V2__Add_surname.sql[]
----
...
----
include::https://raw.githubusercontent.com/{organization}/{repo}/master/{module}/src/main/java/sample/flyway/Person.java[]
----